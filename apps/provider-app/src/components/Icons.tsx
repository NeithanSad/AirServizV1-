// Shared inline SVG icons (Feather-style: 24px viewBox, stroke = currentColor)
// Replaces all emoji usage across the provider-app.
...
export const BriefcaseIcon = ({ size, className }: IconProps) => (
  <svg {...base(size)} className={className}>
